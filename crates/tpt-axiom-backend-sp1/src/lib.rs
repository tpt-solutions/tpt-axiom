...
//! [`tpt_axiom_zk::ZkBackend`] for SP1, compiling the backend-agnostic
//! [`tpt_axiom_ir::ConstraintSystem`] into an SP1 program and generating real
//! proofs.
...
/// The SP1 [`tpt_axiom_zk::ZkBackend`] implementation (Phase 4).
